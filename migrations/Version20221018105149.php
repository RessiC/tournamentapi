 ...
 */
final class Version20221018105149 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT game_ibfk_1 FOREIGN KEY (tournament_id) REFERENCES tournament (id) ON UPDATE CASCADE');
